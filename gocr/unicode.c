...
/* FIXME jb global */
int warnCode=0; /* if 1 a message is generated if composition is not defined */
...
/* supported by now: part of ISO8859-1, basic greek characters */
...
#endif
  if(main>127 && modifier!=0 && modifier!=SPACE && warnCode)
  ...
  switch (modifier) {
	...
	default:
          if(warnCode)fprintf( stderr, " COMPOSE: ACUTE_ACCENT+%04x not defined\n",(int)main);
      }
      break;
	...
	default:
          if(warnCode)fprintf( stderr, " COMPOSE: BREVE+%04x not defined\n",(int)main);
      }
      break;
	...
	default:
          if(warnCode)fprintf( stderr, " COMPOSE: CARON+%04x not defined\n",(int)main);
      }
      break;
	...
	default:
          if(warnCode)fprintf( stderr, " COMPOSE: CEDILLA+%04x not defined\n",(int)main);
      }
      break;
	...
	default:
          if(warnCode)fprintf( stderr, " COMPOSE: TILDE+%04x not defined\n",(int)main);
      }
      break;
	...
	default:
          if(warnCode)fprintf( stderr, " COMPOSE: GRAVE_ACCENT+%04x not defined\n",(int)main);
      }
      break;
	...
	default:
          if(warnCode)fprintf( stderr, " COMPOSE: DIAERESIS+%04x (%c) not defined\n",(int)main,(char)main);
      }
      break;
	...
	default:
          if(warnCode)fprintf( stderr, " COMPOSE: CIRCUMFLEX_ACCENT+%04x not defined\n",(int)main);
      }
      break;
	...
	case ' ':	    return MODIFIER_LETTER_MACRON;
        default:
          if(warnCode)fprintf( stderr, " COMPOSE: MACRON+%04x not defined\n",(int)main);
      }
      break;
	...
	case '.':	    return ':';
        default:
          if(warnCode)fprintf( stderr, " COMPOSE: DOT_ABOVE+%04x not defined\n",(int)main);
      }
      break;
	...
	case 'A':	    return LATIN_CAPITAL_LETTER_A_WITH_RING_ABOVE;
        ...
        default:
          if(warnCode)fprintf( stderr, " COMPOSE: RING_ABOVE+%04x not defined\n",(int)main);
      }
      break;
	...
	default:
          if(warnCode)fprintf( stderr, " COMPOSE: %04x+e/E not defined\n",(int)main);
      }
      break;
...
*/
	default:
          if(warnCode)fprintf( stderr, " COMPOSE: GREEK %04x not defined\n",(int)main);
      }
      break;   
